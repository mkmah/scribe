defmodule SocialScribeWeb.ChatPopup do
    ...
    <div id="chat-popup-wrapper">
      ...
      <button
        ...
        class={[
          ...
          "bg-brand-500 text-white hover:bg-brand-600 dark:bg-brand-500 dark:hover:bg-brand-500",
      ...
      <div
        ...
        class={[
          ...
          "bg-white dark:bg-[#1c1c1c] rounded-2xl shadow-2xl border border-gray-200 dark:border-[#2e2e2e]",
      ...
      >
        ...
        <div class="flex-shrink-0 px-5 pt-5 pb-3">
          <div class="flex items-center justify-between mb-3">
            <h2 class="text-lg font-semibold tracking-tight text-gray-900 dark:text-gray-100">Ask Anything</h2>
            <div class="flex items-center gap-1">
              <button
                phx-click="new_chat"
                phx-target={@myself}
                class="p-1.5 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-[#2a2a2a] rounded-lg transition-colors cursor-pointer"
                title="New chat"
              >
          ...
          <%!-- Tabs --%>
          <div class="flex gap-4 border-b border-gray-200 dark:border-[#2e2e2e]">
            <button
              ...
              class={[
                ...
                if(@active_tab == :chat,
                  do: "text-gray-900 dark:text-gray-100 border-gray-900 dark:border-gray-100",
                  else: "text-gray-400 dark:text-gray-500 border-transparent hover:text-gray-600 dark:hover:text-gray-300"
                )
              ]}
            >
              Chat
          ...
          <%= if @active_tab == :chat do %>
                ...
                <%= for message <- @messages do %>
                  <%= if message.role == "user" do %>
                    <div class="flex justify-end">
                      <div class="max-w-[85%] bg-gray-100 dark:bg-[#232323] rounded-2xl rounded-br-md px-4 py-2.5">
              ...
              <div :if={@loading} class="flex justify-start">
                <div class="flex items-center gap-2">
                  <div class="flex gap-1">
                    <span class="w-1.5 h-1.5 bg-gray-400 dark:bg-gray-500 rounded-full animate-bounce [animation-delay:0ms]"></span>
                    <span class="w-1.5 h-1.5 bg-gray-400 dark:bg-gray-500 rounded-full animate-bounce [animation-delay:150ms]"></span>
                    <span class="w-1.5 h-1.5 bg-gray-400 dark:bg-gray-500 rounded-full animate-bounce [animation-delay:300ms]"></span>
                  </div>
            ...
            <div class="flex-shrink-0 px-4 pt-2 pb-4">
              <form id="chat-popup-form" phx-submit="send_message" phx-target={@myself}>
                <div class="border border-gray-200 dark:border-[#2e2e2e] rounded-xl overflow-hidden focus-within:border-brand-400 dark:focus-within:border-brand-500 focus-within:ring-1 focus-within:ring-brand-400 dark:focus-within:ring-brand-500 transition-all">
                  <%!-- Add Context button at top --%>
                  <div class="px-3 pt-2.5">
                    <button
                      type="button"
                      class="inline-flex items-center gap-1.5 px-2.5 py-1 text-xs font-medium text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 bg-gray-50 dark:bg-[#232323] hover:bg-gray-100 dark:hover:bg-[#2a2a2a] border border-gray-200 dark:border-[#2e2e2e] rounded transition-colors cursor-pointer"
                    >
                      @ Add context
                    </button>
                  </div>
                  ...
                  <div class="flex items-center justify-between px-3 pb-2.5">
                    <div class="flex items-center gap-2">
                      <span class="text-xs text-gray-400 dark:text-gray-500">Sources</span>
                      <div class="flex -space-x-1.5">
                        <div class="w-5 h-5 rounded-full bg-[#00A1E0] flex items-center justify-center ring-2 ring-white dark:ring-[#1c1c1c]" title="Salesforce">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-3 h-3" fill="white">
                        ...
                        <div class="w-5 h-5 rounded-full bg-[#FF7A59] flex items-center justify-center ring-2 ring-white dark:ring-[#1c1c1c]" title="HubSpot">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-3 h-3" fill="white">
                        ...
                        <div class="w-5 h-5 rounded-full bg-[#EA4335] flex items-center justify-center ring-2 ring-white dark:ring-[#1c1c1c]" title="Gmail">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-3 h-3" fill="white">
            ...
            <div class="flex-1 overflow-y-auto px-5 py-4 space-y-1.5 scrollbar-thin">
              <%= if Enum.empty?(@conversations) do %>
                <div class="py-12 text-center">
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 mx-auto mb-3 text-gray-200 dark:text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193-.34.027-.68.052-1.02.072v3.091l-3-3c-1.354 0-2.694-.055-4.02-.163a2.115 2.115 0 01-.825-.242m9.345-8.334a2.126 2.126 0 00-.476-.095 48.64 48.64 0 00-8.048 0c-1.131.094-1.976 1.057-1.976 2.192v4.286c0 .837.46 1.58 1.155 1.951m9.345-8.334V6.637c0-1.621-1.152-3.026-2.76-3.235A48.455 48.455 0 0011.25 3c-2.115 0-4.198.137-6.24.402-1.608.209-2.76 1.614-2.76 3.235v6.226c0 1.621 1.152 3.026 2.76 3.235.577.075 1.157.14 1.74.194V21l4.155-4.155" />
                  </svg>
                  <p class="text-sm font-medium text-gray-500 dark:text-gray-400">No conversations yet</p>
                  <p class="mt-1 text-xs text-gray-400 dark:text-gray-500">Start a new chat to get started</p>
                </div>
              <% else %>
                <button
  ...
  defp format_message_content(content) do
    ...
    |> String.replace(~r/@([A-Z][a-zA-Z]+(?:\s+[A-Z][a-zA-Z]+)*)/, fn match ->
      "<span class=\"text-brand-500 dark:text-brand-400 font-medium\">#{match}</span>"
    end)
    |> Phoenix.HTML.raw()
  end
end
